...
export default function AgentLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Verify user role is agent; create profile if missing (dev fallback)
      ...
      if (!profile) {
        // Fallback: create profile when trigger hasn't run yet
      ...
      if (profile.role !== 'agent') {
        ...
        throw new Error('Access denied. Agent accounts only.')
      }
    ...
    <div className="min-h-screen flex items-center justify-center bg-kasi-black p-4">
      <div className="bg-gray-900 p-8 rounded-lg shadow-2xl w-full max-w-md border border-gray-800">
        ...
        <div className="mt-6 text-center">
          <Link href="/agent/signup" className="text-kasi-blue hover:text-opacity-80 text-sm">

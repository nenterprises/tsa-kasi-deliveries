...
export default function StoreDashboard() {
  ...
  const loadDashboardData = async (storeId: string) => {
    ...
    // Get in-progress orders (preparing/ready)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-kasi-blue/50 transition-all shadow-lg">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-12 h-12 rounded-full bg-kasi-blue/20 flex items-center justify-center">
              <svg className="w-6 h-6 text-kasi-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
              </svg>
            </div>
            <p className="text-3xl sm:text-4xl font-bold text-white">{newOrders.length}</p>
          </div>
          <p className="text-sm text-gray-400">New Orders</p>
        </div>

        <div className="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-kasi-orange/50 transition-all shadow-lg">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-12 h-12 rounded-full bg-kasi-orange/20 flex items-center justify-center">
              <svg className="w-6 h-6 text-kasi-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <p className="text-3xl sm:text-4xl font-bold text-white">{inProgressOrders.length}</p>
          </div>
          <p className="text-sm text-gray-400">In Progress</p>
        </div>

        <div className="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-green-500/50 transition-all shadow-lg">
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-3xl sm:text-4xl font-bold text-white">{completedToday.length}</p>
          </div>
          <p className="text-sm text-gray-400">Completed Today</p>
        </div>

        <div className="bg-gray-900/80 backdrop-blur border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-purple-500/50 transition-all shadow-lg">
          <div className="flex items-center gap-3 mb-3">
            ...
            <p className="text-3xl sm:text-4xl font-bold text-white">R{getTodaySales().toFixed(2)}</p>
          </div>
      ...
      {/* New Orders Alert */}
      {newOrders.length > 0 && (
        <div className="bg-yellow-900/20 backdrop-blur border border-yellow-800/50 rounded-2xl p-4 sm:p-5 shadow-lg">
